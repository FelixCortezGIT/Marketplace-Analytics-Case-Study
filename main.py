...
plt.tight_layout()
plt.savefig("cleaned_data/12_avg_order_value_by_country.png", dpi=150, bbox_inches="tight")
plt.close()
...
plt.tight_layout()
plt.savefig("cleaned_data/17_heatmap_marketplace_country.png", dpi=150, bbox_inches="tight")
plt.close()
